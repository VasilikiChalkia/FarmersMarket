...
{
    /// <inheritdoc />
    public partial class AddSellerRegistry : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellerLicenses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SellerLicenses_Sellers_SellerId",
                        column: x => x.SellerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SellerLicenses_SellerId",
